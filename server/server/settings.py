...
SECRET_KEY = 'django-insecure-82rifh$y!m0b-xs410axxr+^*^&90@ptltk79*@hnlh_x+i9_@'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Changed from AllowAny to require auth by default
    ],
