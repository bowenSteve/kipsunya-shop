                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-column">
                            <div className="footer-logo">
                                <div className="footer-brand-circle">K.</div>
                                <span className="footer-brand-text">Kipsunya</span>
                            </div>
                            <p className="footer-description">
                                Your premier destination for quality products across multiple categories. 
                                From kitchen essentials to beauty products, we bring you the best selection at great prices.
                            </p>
                        ...
                        <div className="footer-column">
                            ...
                            <ul className="footer-links">
                                ...
                                <li><Link to="/products" className="footer-link">Featured Items</Link></li>
                                ...
                                <li><Link to="/products" className="footer-link">Gift Cards</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="footer-column">
                            ...
                            <ul className="footer-links">
                                <li><Link to="/products" className="footer-link">Kitchen & Home</Link></li>
                                <li><Link to="/products" className="footer-link">Electronics</Link></li>
                                <li><Link to="/products" className="footer-link">Beauty & Health</Link></li>
                                <li><Link to="/products" className="footer-link">Beverages</Link></li>
                ...
                <div className="footer-bottom">
                    <div className="footer-bottom-content">
                        <div className="footer-bottom-left">
                            <p>&copy; {currentYear} Kipsunya. All rights reserved.</p>
                        </div>
                        <div className="footer-bottom-right">
                            ...
                            <span className="footer-divider">|</span>
                            <Link to="/about" className="footer-bottom-link">Cookie Policy</Link>
                        </div>
                    </div>
                </div>
            </div>
